...
public:
	...
	friend bool check (const CVector &vector, const CPoint &point);
};
...
public:
	...
	friend bool check (const CVector &, const CPoint &);
};
...
{
	return (vector.begin.x == point.x && vector.begin.y == point.y);
}
